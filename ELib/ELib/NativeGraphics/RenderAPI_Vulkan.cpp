...
void* RenderAPI_Vulkan::BeginModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int channel, int* outRowPitch)
{
...
void RenderAPI_Vulkan::EndModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int channel, int rowPitch, void* dataPtr)
{
...
void RenderAPI_Vulkan::GetTextureBuffer(void* bufferHandle,int textureWidth, int textureHeight, int channel,void* dataPtr)
{

}
void RenderAPI_Vulkan::GetVertextBuffer(void* bufferHandle, void* &dataPtr, int& len)
{
