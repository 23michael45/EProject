...
void* RenderAPI_Metal::BeginModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int channel, int* outRowPitch)
{
...
void RenderAPI_Metal::EndModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int channel, int rowPitch, void* dataPtr)
{
...
void RenderAPI_Metal::GetTextureBuffer(void* bufferHandle,int textureWidth, int textureHeight, int channel,void* dataPtr)
{

}
void RenderAPI_Metal::GetVertextBuffer(void* bufferHandle, void* &dataPtr, int& len)
{
