...
public:
	...
	virtual void* BeginModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int channel, int* outRowPitch) = 0;
	// End modifying texture data.
	virtual void EndModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int channel, int rowPitch, void* dataPtr) = 0;

	virtual void ModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int channel, int rowPitch, void* dataPtr) = 0;
	...
	// Get Texture Data
	virtual void GetTextureBuffer(void* bufferHandle,int textureWidth, int textureHeight, int channel,void* dataPtr) = 0;

	// Get Vertex Buffer Data
	virtual void GetVertextBuffer(void* bufferHandle, void* &dataPtr, int& len) = 0;
};
