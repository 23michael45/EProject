...
void* RenderAPI_OpenGLCoreES::BeginModifyTexture(void* textureHandle, int textureWidth, int textureHeight,int channel, int* outRowPitch)
{
...
void RenderAPI_OpenGLCoreES::EndModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int channel, int rowPitch, void* dataPtr)
{
...
void RenderAPI_OpenGLCoreES::ModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int channel, int rowPitch, void* dataPtr)
{
	GLuint gltex = (GLuint)(size_t)(textureHandle);
	// Update texture data, and free the memory buffer
	glBindTexture(GL_TEXTURE_2D, gltex);
...
void RenderAPI_OpenGLCoreES::GetTextureBuffer(void* bufferHandle,int textureWidth, int textureHeight, int channel,void* dataPtr)
{
	...
	//glGetTexParameteriv(GL_TEXTURE_2D, GL_TEXTURE_WIDTH, &wtex);
